...
gulp.task('styles', function() {
  return gulp
    .src('./scuole/static_src/scss/*.scss')
...
gulp.task('favicon', function() {
  return gulp
    .src('./scuole/static_src/favicon.ico')
    .pipe(gulp.dest('./scuole/static/root'))
    .pipe($.size({ title: 'favicon' }));
});

gulp.task('robots', function() {
  return gulp
    .src('./scuole/static_src/robots.txt')
    .pipe(gulp.dest('./scuole/static/root'))
...
gulp.task('sitemap', function() {
  return gulp
    .src('./scuole/static_src/sitemap.xml')
    .pipe(gulp.dest('./scuole/static/root'))
