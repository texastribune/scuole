...
class CountyCohorts(CohortsBase):
    county = models.ForeignKey(County, on_delete=models.CASCADE, related_name="cohorts")
    year = models.ForeignKey(
        SchoolYear, on_delete=models.CASCADE, related_name="county_cohorts"
    )

    class Meta:
        unique_together = ("county", "year", "economic_status", "gender", "ethnicity")
