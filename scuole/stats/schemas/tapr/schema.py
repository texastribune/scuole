SCHEMA = {
    'staff-and-student-information': {
        ...
        'teacher_african_american_count': 'PSTBLFC',
        'teacher_american_indian_count': 'PSTINFC',
        'teacher_asian_count': 'PSTASFC',
        'teacher_hispanic_count': 'PSTHIFC',
        'teacher_pacific_islander_count': 'PSTPIFC',
        'teacher_two_or_more_races_count': 'PSTTWFC',
        'teacher_white_count': 'PSTWHFC',
        'teacher_african_american_percent': 'PSTBLFP',
        'teacher_american_indian_percent': 'PSTINFP',
        'teacher_asian_percent': 'PSTASFP',
        'teacher_hispanic_percent': 'PSTHIFP',
        'teacher_pacific_islander_percent': 'PSTPIFP',
        'teacher_two_or_more_races_percent': 'PSTTWFP',
        'teacher_white_percent': 'PSTWHFP',
