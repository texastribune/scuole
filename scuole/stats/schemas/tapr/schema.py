SCHEMA = {
    ...
    'postsecondary-readiness-and-non-staar-performance-indicators': {
        ...
        'four_year_graduate_all_students_count': 'CAGC4X',
        'four_year_graduate_all_students_percent': 'CAGC4X',
        'four_year_graduate_african_american_count': 'CBGC4X',
        'four_year_graduate_african_american_percent': 'CBGC4X',
        'four_year_graduate_american_indian_count': 'CIGC4X',
        'four_year_graduate_american_indian_percent': 'CIGC4X',
        'four_year_graduate_asian_count': 'C3GC4X',
        'four_year_graduate_asian_percent': 'C3GC4X',
        'four_year_graduate_hispanic_count': 'CHGC4X',
        'four_year_graduate_hispanic_percent': 'CHGC4X',
        'four_year_graduate_pacific_islander_count': 'C4GC4X',
        'four_year_graduate_pacific_islander_percent': 'C4GC4X',
        'four_year_graduate_two_or_more_races_count': 'C2GC4X',
        'four_year_graduate_two_or_more_races_percent': 'C2GC4X',
        'four_year_graduate_white_count': 'CWGC4X',
        'four_year_graduate_white_percent': 'CWGC4X',
        'four_year_graduate_at_risk_count': 'CRGC4X',
        'four_year_graduate_at_risk_percent': 'CRGC4X',
        'four_year_graduate_economically_disadvantaged_count': 'CEGC4X',
        'four_year_graduate_economically_disadvantaged_percent': 'CEGC4X',
