SCHEMA = {
    'staff-and-student-information': {
        ...
        'class_size_avg_kindergarten': 'CPCTGKGA',
        'class_size_avg_first': 'CPCTG01A',
        'class_size_avg_second': 'CPCTG02A',
        'class_size_avg_third': 'CPCTG03A',
        'class_size_avg_fourth': 'CPCTG04A',
        'class_size_avg_fifth': 'CPCTG05A',
        'class_size_avg_sixth': 'CPCTG06A',
        'class_size_avg_mixed_elementary': 'CPCTGMEA',
        'class_size_avg_secondary_english': 'CPCTENGA',
        'class_size_avg_secondary_foreign_language': 'CPCTFLAA',
        'class_size_avg_secondary_math': 'CPCTMATA',
        'class_size_avg_secondary_science': 'CPCTSCIA',
        'class_size_avg_secondary_social_studies': 'CPCTSOCA',
