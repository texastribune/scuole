SCHEMA = {
    ...
    'postsecondary-readiness-and-non-staar-performance-indicators': {
        ...
        'college_ready_graduates_english_native_american_count': 'ICRR',
        'college_ready_graduates_english_native_american_percent': 'ICRR',
        ...
        'college_ready_graduates_math_native_american_count': 'ICRB',
        'college_ready_graduates_math_native_american_percent': 'ICRB',
        ...
        'college_ready_graduates_both_all_students_count': 'ACRR',
        'college_ready_graduates_both_all_students_percent': 'ACRR',
        ...
        'college_ready_graduates_both_native_american_count': 'ICRB',
        'college_ready_graduates_both_native_american_percent': 'ICRB',
        ...
        'college_ready_econ_disadv_both_count': '',
        'college_ready_econ_disadv_both_percent': '',
        'avg_sat_score_all_students': 'CA0CSA',
        'avg_sat_score_african_american': 'CB0CSA',
        'avg_sat_score_american_indian': 'CI0CSA',
        'avg_sat_score_asian': 'C30CSA',
        'avg_sat_score_hispanic': 'CH0CSA',
        'avg_sat_score_native_american': '',
        'avg_sat_score_pacific_islander': 'C40CSA',
        'avg_sat_score_two_or_more_races': 'C20CSA',
        'avg_sat_score_white': 'CW0CSA',
        'avg_sat_score_econ_disadv': 'CE0CSA',
        'avg_act_score_all_students': 'CA0CAA',
        'avg_act_score_african_american': 'CB0CAA',
        'avg_act_score_american_indian': 'CI0CAA',
        'avg_act_score_asian': 'C30CAA',
        'avg_act_score_hispanic': 'CH0CAA',
        'avg_act_score_native_american': '',
        'avg_act_score_pacific_islander': 'C40CAA',
        'avg_act_score_two_or_more_races': 'C20CAA',
        'avg_act_score_white': 'CW0CAA',
        'avg_act_score_econ_disadv': 'CE0CAA',
        'dropout_all_students_count': '',
        'dropout_african_american_count': 'CB0912DR',
        'dropout_african_american_percent': 'CB0912DR',
        'dropout_asian_count': 'C30912DR',
        'dropout_asian_percent': 'C30912DR',
        'dropout_hispanic_count': 'CH0912DR',
        'dropout_hispanic_percent': 'CH0912DR',
        'dropout_native_american_count': 'CI0912DR',
        'dropout_native_american_percent': 'CI0912DR',
        'dropout_pacific_islander_count': 'C40912DR',
        'dropout_pacific_islander_percent': 'C40912DR',
        'dropout_two_or_more_races_count': 'C20912DR',
        'dropout_two_or_more_races_percent': 'C20912DR',
        'dropout_white_count': 'CW0912DR',
        'dropout_white_percent': 'CW0912DR',
        'dropout_at_risk_count': 'CR0912DR',
        'dropout_at_risk_percent': 'CR0912DR',
        'dropout_econ_disadv_count': 'CE0912DR',
        'dropout_econ_disadv_percent': 'CE0912DR',
    }
}
