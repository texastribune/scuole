SCHEMA = {
    'staff-and-student-information': {
        ...
        'teacher_base_salary_avg': 'PSTTOSA',
        'teacher_beginning_salary_avg': 'CPST00SA',
        'teacher_one_thru_five_salary_avg': 'CPST01SA',
        'teacher_six_thru_ten_salary_avg': 'CPST06SA',
        'teacher_eleven_thru_twenty_salary_avg': 'CPST11SA',
        'teacher_over_twenty_salary_average': 'CPST20SA',
    },
