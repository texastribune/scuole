SCHEMA = {
    'staff-and-student-information': {
        ...
        'teacher_beginning_salary_avg': '',
        'teacher_one_thru_five_salary_avg': '',
        'teacher_six_thru_ten_salary_avg': '',
        'teacher_eleven_thru_twenty_salary_avg': '',
        'teacher_over_twenty_salary_average': '',
    },
