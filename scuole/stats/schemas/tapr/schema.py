SCHEMA = {
    ...
    'postsecondary-readiness-and-non-staar-performance-indicators': {
        ...
        'dropout_african_american_count': '',
        'dropout_african_american_percent': '',
        'dropout_american_indian_count': '',
        'dropout_american_indian_percent': '',
        'dropout_asian_count': '',
        'dropout_asian_percent': '',
        'dropout_hispanic_count': '',
        'dropout_hispanic_percent': '',
        'dropout_pacific_islander_count': '',
        'dropout_pacific_islander_percent': '',
        'dropout_two_or_more_races_count': '',
        'dropout_two_or_more_races_percent': '',
        'dropout_white_count': '',
        'dropout_white_percent': '',
    }
}
