...
googletag.cmd.push(function () {
  ...
  var metricsMapping = googletag.sizeMapping()
    .addSize([510, 1], [468, 60])
    .addSize([0, 0], [300, 250])
    .build()

  googletag.defineSlot('/5805113/TexasTribune_Data_DataPage_ATF_Header_Leaderboard_728x90', [728, 90], 'ad-banner-leader')
  ...
  googletag.defineSlot('/5805113/TexasTribune_Data_DataPage_BTF_Footer_Leaderboard_728x90', [728, 90], 'ad-banner-footer')
    .defineSizeMapping(bannerMapping)
    .addService(googletag.pubads())
