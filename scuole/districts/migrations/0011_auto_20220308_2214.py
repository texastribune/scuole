# Generated by Django 3.1.12 on 2022-03-08 22:14
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('districts', '0010_auto_20220120_2217'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(blank=True, choices=[('M', 'Met standard'), ('A', 'Met alternative standard'), ('T', 'Met alternative standard'), ('I', 'Improvement required'), ('X', 'Not rated'), ('Z', 'Not rated'), ('Q', 'Not rated (data integrity issue)'), ('T', 'Not rated (Annexed)'), ('H', 'Not rated (Harvey provision)'), ('P', 'Not rated (Paired campus)'), ('DD', 'Not Rated: Declared State of Disaster'), ('', None)], default='', max_length=2, verbose_name='School progress rating from 2018-19'),
        ),
        migrations.AddField(
            model_name='districtstats',
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, choices=[('M', 'Met standard'), ('A', 'Met alternative standard'), ('T', 'Met alternative standard'), ('I', 'Improvement required'), ('X', 'Not rated'), ('Z', 'Not rated'), ('Q', 'Not rated (data integrity issue)'), ('T', 'Not rated (Annexed)'), ('H', 'Not rated (Harvey provision)'), ('P', 'Not rated (Paired campus)'), ('DD', 'Not Rated: Declared State of Disaster'), ('', None)], default='', max_length=2, verbose_name='Accountability rating from the latest year'),
        ),
        migrations.AlterField(
            model_name='districtstats',
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, choices=[('M', 'Met standard'), ('A', 'Met alternative standard'), ('T', 'Met alternative standard'), ('I', 'Improvement required'), ('X', 'Not rated'), ('Z', 'Not rated'), ('Q', 'Not rated (data integrity issue)'), ('T', 'Not rated (Annexed)'), ('H', 'Not rated (Harvey provision)'), ('P', 'Not rated (Paired campus)'), ('DD', 'Not Rated: Declared State of Disaster'), ('', None)], default='', max_length=2, verbose_name='School progress rating from the latest year'),
        ),
        migrations.AlterField(
            model_name='districtstats',
