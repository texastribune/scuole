    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=20, verbose_name='Geographic name for region')),
                ('region_id', models.CharField(max_length=2, verbose_name='Region identifier')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='stats', to='regions.Region')),
                ('year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='region_stats', to='stats.SchoolYear')),
            ],
            options={
