    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cohort_year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='region_cohort', to='cohorts.CohortsYear')),
                ('region_cohort', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cohort', to='regions.Region')),
            ],
            options={
                'verbose_name_plural': 'Region cohort',
            },
        ),
        migrations.AlterUniqueTogether(
            name='regioncohort',
            unique_together=set([('region_cohort', 'cohort_year')]),
        ),
    ]
