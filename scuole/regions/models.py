...
class RegionStats(StatsBase):
    ...
    year = models.ForeignKey(
        SchoolYear, on_delete=models.CASCADE, related_name="region_stats"
    )
...
class RegionCohorts(CohortsBase):
    ...
    year = models.ForeignKey(
        SchoolYear, on_delete=models.CASCADE, related_name="region_cohorts"
    )

    class Meta:
        unique_together = ("region", "year", "gender", "ethnicity", "economic_status")
