    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(help_text='Campus location city', max_length=200)),
                ('street', models.CharField(help_text='Campus location street address', max_length=200)),
                ('state', models.CharField(help_text='Campus location state', max_length=5)),
                ('zip_code', models.CharField(help_text='Campus location zip', max_length=5)),
                ('zip_code4', models.CharField(help_text='Campus +4 zip', max_length=4)),
