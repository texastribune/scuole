    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('street', models.CharField(max_length=100, null=True, verbose_name='Campus street')),
                ('city', models.CharField(max_length=200, null=True, verbose_name='Campus city')),
                ('state', localflavor.us.models.USStateField(choices=[('AL', 'Alabama'), ('AK', 'Alaska'), ('AS', 'American Samoa'), ('AZ', 'Arizona'), ('AR', 'Arkansas'), ('AA', 'Armed Forces Americas'), ('AE', 'Armed Forces Europe'), ('AP', 'Armed Forces Pacific'), ('CA', 'California'), ('CO', 'Colorado'), ('CT', 'Connecticut'), ('DE', 'Delaware'), ('DC', 'District of Columbia'), ('FL', 'Florida'), ('GA', 'Georgia'), ('GU', 'Guam'), ('HI', 'Hawaii'), ('ID', 'Idaho'), ('IL', 'Illinois'), ('IN', 'Indiana'), ('IA', 'Iowa'), ('KS', 'Kansas'), ('KY', 'Kentucky'), ('LA', 'Louisiana'), ('ME', 'Maine'), ('MD', 'Maryland'), ('MA', 'Massachusetts'), ('MI', 'Michigan'), ('MN', 'Minnesota'), ('MS', 'Mississippi'), ('MO', 'Missouri'), ('MT', 'Montana'), ('NE', 'Nebraska'), ('NV', 'Nevada'), ('NH', 'New Hampshire'), ('NJ', 'New Jersey'), ('NM', 'New Mexico'), ('NY', 'New York'), ('NC', 'North Carolina'), ('ND', 'North Dakota'), ('MP', 'Northern Mariana Islands'), ('OH', 'Ohio'), ('OK', 'Oklahoma'), ('OR', 'Oregon'), ('PA', 'Pennsylvania'), ('PR', 'Puerto Rico'), ('RI', 'Rhode Island'), ('SC', 'South Carolina'), ('SD', 'South Dakota'), ('TN', 'Tennessee'), ('TX', 'Texas'), ('UT', 'Utah'), ('VT', 'Vermont'), ('VI', 'Virgin Islands'), ('VA', 'Virginia'), ('WA', 'Washington'), ('WV', 'West Virginia'), ('WI', 'Wisconsin'), ('WY', 'Wyoming')], max_length=2, null=True, verbose_name='Campus state')),
                ('zip_code', localflavor.us.models.USZipCodeField(max_length=10, null=True, verbose_name='Campus ZIP Code')),
                ('locale', models.CharField(max_length=15, verbose_name='Campus NCES urban-centric locale identifier')),
                ('coordinates', django.contrib.gis.db.models.fields.PointField(null=True, srid=4326)),
                ('low_grade', models.CharField(choices=[('EE', 'Early education'), ('PK', 'Pre-kindergarten'), ('KG', 'Kindergarten'), ('01', '1st grade'), ('02', '2nd grade'), ('03', '3rd grade'), ('04', '4th grade'), ('05', '5th grade'), ('06', '6th grade'), ('07', '7th grade'), ('08', '8th grade'), ('09', '9th grade'), ('10', '10th grade'), ('11', '11th grade'), ('12', '12th grade')], max_length=2, verbose_name='Lowest grade offered')),
                ('high_grade', models.CharField(choices=[('EE', 'Early education'), ('PK', 'Pre-kindergarten'), ('KG', 'Kindergarten'), ('01', '1st grade'), ('02', '2nd grade'), ('03', '3rd grade'), ('04', '4th grade'), ('05', '5th grade'), ('06', '6th grade'), ('07', '7th grade'), ('08', '8th grade'), ('09', '9th grade'), ('10', '10th grade'), ('11', '11th grade'), ('12', '12th grade')], max_length=2, verbose_name='Highest grade offered')),
                ('school_type', models.CharField(choices=[('E', 'Elementary school'), ('M', 'Middle school or junior high school'), ('S', 'High school'), ('B', 'Elementary/secondary school')], max_length=1, verbose_name='School type')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campus', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='stats', to='campuses.Campus')),
                ('year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='campus_stats', to='stats.SchoolYear')),
            ],
            options={
